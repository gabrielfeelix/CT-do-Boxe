                            ...
                            <div className="flex flex-wrap items-start gap-2">
                                {aluno.telefone && (
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-4 py-2.5 text-sm font-bold text-white bg-[#25D366] hover:bg-[#128C7E] rounded-xl shadow-sm hover:shadow-md transition-all duration-200"
                                    >
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2.5 text-sm font-bold text-gray-700 bg-gray-50 hover:bg-gray-100 border border-gray-200 hover:border-gray-300 rounded-xl shadow-sm transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
                                >
                                    {aluno.status === 'bloqueado' ? (
                                        <><ShieldCheck className="h-4 w-4 text-green-600" /> Liberar</>
                                    ) : (
                                        <><Lock className="h-4 w-4 text-amber-600" /> Bloquear</>
                                    )}
                                </button>
                                {aluno.status !== 'cancelado' && (
                                    <button
                                        ...
                                        disabled={salvando}
                                        className="flex items-center gap-2 px-4 py-2.5 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
